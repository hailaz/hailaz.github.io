...
| UI 库 | **WeUI 规范** / Tailwind CSS | Shadcn / AntD / Arco / TDesign |
...
5. **打开 Preview**：双击 `preview/preview-template.html`，查看 11 种小程序页面骨架
...
│       ├── minimal.json
│       └── cyberpunk.json
├── configurator/            # 内置可视化配置网页（含小程序 Tab）
├── preview/                 # 可交互小程序原型 + Web 原型
├── templates/
